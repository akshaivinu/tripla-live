...
const attractions = [
  ...
  },
  {
    ...
    size: "sm",
    fallback:
      "https://images.unsplash.com/photo-1509233725247-49e657c54213?auto=format&fit=crop&q=80&w=1000",
  },
  {
    id: "rink",
    title: "The Rink",
    ...
    size: "sm",
    fallback:
      "https://images.unsplash.com/photo-1517177326540-a55d336d376d?auto=format&fit=crop&q=80&w=1000",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8">
        <h3
          className={`font-bold outfit uppercase mb-2 ${attr.size === "lg" ? "text-2xl md:text-4xl" : "text-lg md:text-xl"}`}
        >
          {attr.title}
        </h3>
