      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-2xl bg-zinc-900 border border-white/10 rounded-2xl md:rounded-[2.5rem] overflow-hidden shadow-2xl"
          >
            <div className="p-6 md:p-12">
              <div className="flex justify-between items-start mb-10">
                <div>
                  <h2 className="text-3xl font-bold outfit uppercase text-white mb-2">
                    Leasing Inquiry
                  </h2>
                  <p className="text-zinc-500 text-sm uppercase tracking-widest">
                    Global Flagship Opportunities
                  </p>
                </div>
                <button
                  onClick={onClose}
              ...
              <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-white/20 transition-all font-light"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-white/20 transition-all font-light"
                    placeholder="Luxury Lifestyle Inc."
                  />
                </div>
            ...
            <div className="bg-white/5 p-6 text-center border-t border-white/5">
              <p className="text-[10px] text-zinc-600 uppercase tracking-widest">
                Our leasing team typically responds within 24 business hours.
              </p>
            </div>
          </motion.div>
        </div>
