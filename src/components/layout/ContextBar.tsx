          ...
          <div className="glass px-4 py-3 md:px-8 md:py-4 rounded-full border border-white/10 flex items-center justify-between backdrop-blur-xl gap-4">
            <div className="flex items-center gap-6">
              <div className="flex flex-col">
                <span className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 mb-1 font-medium">
                  Viewing
                </span>
                <span className="text-sm font-bold outfit uppercase text-white tracking-widest">
                  {current.label}
                </span>
              </div>
